      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            std::cout<<"Previous size: "<<previous_size<<endl;
            if(previous_size != 0)
            {
                car_acceleration = previous_path_d2s[51-previous_size];
                car_speed = previous_path_ds[49-previous_size];
                car_s = previous_path_s[49-previous_size];
            }
